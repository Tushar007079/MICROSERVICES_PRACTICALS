...
public class ObjectFactory {
    ...
    private final static QName _Addition_QNAME = new QName("http://TK/", "Addition");
    private final static QName _AdditionResponse_QNAME = new QName("http://TK/", "AdditionResponse");
    private final static QName _Division_QNAME = new QName("http://TK/", "Division");
    private final static QName _DivisionResponse_QNAME = new QName("http://TK/", "DivisionResponse");
    private final static QName _Multiplication_QNAME = new QName("http://TK/", "Multiplication");
    private final static QName _MultiplicationResponse_QNAME = new QName("http://TK/", "MultiplicationResponse");
    private final static QName _Subtraction_QNAME = new QName("http://TK/", "Subtraction");
    private final static QName _SubtractionResponse_QNAME = new QName("http://TK/", "SubtractionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tk
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://TK/", name = "Addition")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://TK/", name = "AdditionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://TK/", name = "Division")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://TK/", name = "DivisionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://TK/", name = "Multiplication")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://TK/", name = "MultiplicationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://TK/", name = "Subtraction")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://TK/", name = "SubtractionResponse")
