 ...
 * 
 */
@WebServiceClient(name = "CALCULATOR", targetNamespace = "http://TK/", wsdlLocation = "http://localhost:8080/TKCALCULATOR/CALCULATOR?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://TK/", "CALCULATOR");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/TKCALCULATOR/CALCULATOR?WSDL");
    ...
    public CALCULATOR getCALCULATORPort() {
        return super.getPort(new QName("http://TK/", "CALCULATORPort"), CALCULATOR.class);
    }
    ...
    public CALCULATOR getCALCULATORPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://TK/", "CALCULATORPort"), CALCULATOR.class, features);
    }
